...
1.  **PROJECT SCOPE:** Work STRICTLY within Project ID: `build-with-ai-489617`.
...
*   **Query Construction Rules:**
    *   **Aspect Predicates:** For EACH condition identified in Phase 1, append a filter using the syntax:
        `build-with-ai-489617.us-central1.official-data-product-spec.{FIELD}={VALUE}`
...
*   **Example Logic (Internal thought process):**
    ...
    *   *Constructed Query:*
        `build-with-ai-489617.us-central1.official-data-product-spec.data_domain=FINANCE build-with-ai-489617.us-central1.official-data-product-spec.is_certified=true`
...
*   **ALWAYS** use the full path: `build-with-ai-489617.us-central1.official-data-product-spec.{FIELD}={VALUE}`.
